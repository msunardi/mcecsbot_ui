...
- (void)viewDidLoad
{
    ...
    [self.eceLabDetailName.layer setBorderColor:(__bridge CGColorRef)([UIColor greenColor])];
    [self.eceLabDetailName.layer setBorderWidth:1.0];
    ...
    [self.eceLabScrollView setContentMode:UIViewContentModeScaleAspectFit];
    [self.eceLabImage sizeToFit];
